<template>
  ...
  <div class="floating-social">
    ...
    >
      ...
      <span class="social-tooltip right">Facebook</span>
    </a>
    ...
    >
      ...
      <span class="social-tooltip right">Instagram</span>
    </a>
    ...
    >
      ...
      <span class="social-tooltip right">TikTok</span>
    </a>
  </div>
...
/* Tooltip para redes sociales (izquierda) */
.floating-social .social-tooltip.right {
  left: 70px;
}

.floating-social .social-tooltip.right::after {
  content: '';
  position: absolute;
  right: 100%;
  top: 50%;
